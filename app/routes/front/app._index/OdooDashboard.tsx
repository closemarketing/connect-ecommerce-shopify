...
import type { OdooDashboardData } from "./odoo-dashboard-data.server";
    ...
    <div style={{ background: "#f1f3f5", minHeight: "100vh", padding: "24px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          <syncFetcher.Form method="post" action="/app/sync-products-odoo">
            <button
              type="submit"
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px" }}>
          {[
            { icon: "☁️",  value: products.availableInERPSku, label: "Disponibles en Odoo", sub: products.withoutSku > 0 ? `${products.withoutSku} sin SKU` : t("home.prodAvailableSub"), iconBg: "#fff3e8" },
